      ...
      <section className="bg-gradient-to-r from-blue-950 to-blue-900 pt-20 pb-24 px-4 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block">
            <img width="800" height="800" loading="lazy" decoding="async" src="https://storage.googleapis.com/wp-media-henoticbucket/MRI%20SCAN/henotic-diagnostics-waiting-area.webp" alt={`${serviceName} in ${locationName}`} className="rounded-[2rem] shadow-2xl border-4 border-white/10 transform rotate-2 hover:rotate-0 transition-transform duration-500" />
          </div>
        </div>
      </section>
