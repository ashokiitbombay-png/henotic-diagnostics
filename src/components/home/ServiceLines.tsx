...
const services = [
  ...
  { id: "pathology", title: "Clinical Pathology", desc: "Automated analyzers for blood, hormone, and infection markers.", img: "https://storage.googleapis.com/wp-media-henoticbucket/2026/01/88133686-henotic-diagnostics-top-pathology-lab-navi-mumbai-blood-test-near-me-health-checkup-nabl-accredited-lab-mri-scan-ct-scan-genetic-testing.webp", link: "/services/blood-test" }
];
          ...
          {services.map((s) => (
            <Link key={s.id} href={s.link} className="group relative bg-slate-900 rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 h-[350px]">
              <div className="absolute inset-0">
                <img width="800" height="800" decoding="async" src={s.img} alt={s.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-70 group-hover:opacity-40" fetchPriority="high" />
