      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative group">
            ...
            <img width="800" height="800" decoding="async" src="/_next/image?url=https://storage.googleapis.com/wp-media-henoticbucket/2026/01/1a401b0d-henotic-diagnostics-mri-scan-ct-scan-pet-scan-dopa-scan-dtpa-scan.webp&w=1080&q=75" alt="Siemens MRI Machine" className="relative rounded-3xl shadow-2xl z-10 w-full border-4 border-white" fetchPriority="high" />
