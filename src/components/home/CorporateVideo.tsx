    ...
    <section className="py-24 bg-slate-900 relative overflow-hidden border-y border-slate-800">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="relative rounded-[3rem] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)] border border-white/20 group max-w-5xl mx-auto bg-black">
          <video ref={videoRef} src="/_next/image?url=https://storage.googleapis.com/wp-media-henoticbucket/2026/01/4e1a5cd1-henotic_diagnostics_trusted_health_care-corporate-video.mp4&w=1080&q=75" className="w-full h-auto aspect-video object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-500" loop controls={false} />
