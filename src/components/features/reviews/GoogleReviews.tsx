        ...
        <div className="bg-white rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 p-8 md:p-12 flex flex-col lg:flex-row items-center gap-12 mb-16 transition-transform duration-500 hover:-translate-y-2">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="flex items-center gap-3 mb-2">
               <img loading="lazy" decoding="async" src="https://storage.googleapis.com/wp-media-henoticbucket/ICONS-SYMBOLS/google-icon-logo-svgrepo-com.svg" alt="Google" className="w-8 h-8" />
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
              ...
              <div className="flex flex-col items-center sm:items-start">
                <div className="flex gap-1 mb-1">
                  {[...Array(5)].map((_, i) => (
                    <img loading="lazy" decoding="async" key={i} src="https://storage.googleapis.com/wp-media-henoticbucket/ICONS-SYMBOLS/yellow-star.webp" alt="Star" className="w-6 h-6 md:w-8 md:h-8 drop-shadow-sm transform hover:scale-110 transition-transform duration-200" />
                  ))}
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center lg:justify-start">
              ...
              >
                <img loading="lazy" decoding="async" src="https://storage.googleapis.com/wp-media-henoticbucket/ICONS-SYMBOLS/Google_Maps_icon_(2020).svg.png" alt="Google Maps" className="w-5 h-5 group-hover:scale-110 transition-transform" />
                View on Google Maps
              </a>
              <a 
            ...
            <div key={idx} className="bg-white p-8 rounded-3xl border border-slate-100 shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col h-full relative">
              ...
              <div className="flex gap-1 mb-4">
                {[...Array(review.rating)].map((_, i) => (
                  <img loading="lazy" decoding="async" key={i} src="https://storage.googleapis.com/wp-media-henoticbucket/ICONS-SYMBOLS/yellow-star.webp" alt="Star" className="w-4 h-4 drop-shadow-sm" />
                ))}
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 flex items-center gap-2">
                 <img loading="lazy" decoding="async" src="https://storage.googleapis.com/wp-media-henoticbucket/ICONS-SYMBOLS/google-icon-logo-svgrepo-com.svg" alt="Google" className="w-4 h-4" />
