    ...
    >
      ...
      <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-4 items-end pointer-events-none">
        <a href="https://wa.me/918879327184" target="_blank" rel="noreferrer" className="group relative transition-transform hover:scale-110 duration-300 pointer-events-auto" aria-label="Chat on WhatsApp">
          ...
          <Image width={64} height={64} src="https://storage.googleapis.com/wp-media-henoticbucket/2026/01/c65e4696-whatsapp.webp" alt="WhatsApp" className="w-14 h-14 md:w-16 md:h-16 drop-shadow-2xl relative z-10" priority />
        </a>
        <a href={siteConfig.contact.phonePrimaryRaw} className="group relative transition-transform hover:scale-110 duration-300 pointer-events-auto" aria-label="Call Now">
          ...
          <Image width={64} height={64} src="https://storage.googleapis.com/wp-media-henoticbucket/2026/01/0f754a41-call-now.webp" alt="Call Now" className="w-14 h-14 md:w-16 md:h-16 drop-shadow-2xl animate-[pulse_2s_infinite] hover:animate-none relative z-10" priority />
        </a>
      </div>
    </footer>
  );
