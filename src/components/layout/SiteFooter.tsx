    ...
    >
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl w-full relative z-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 mb-8 lg:mb-16 relative z-20">
          ...
          <div>
            <h4 className="font-extrabold uppercase tracking-widest text-xs mb-6 border-b border-white/20 pb-3 text-white/90 drop-shadow-sm">Sitemaps</h4>
            <ul className="flex flex-col gap-2 text-sm font-semibold text-white/90">
              <li><a href="/sitemap/0.xml" className="hover:text-white hover:translate-x-1 transition-all duration-200 flex items-center gap-2"><FileText size={12}/> Core Pages &amp; Services</a></li>
              {Array.from({ length: 17 }, (_, i) => (
                <li key={i + 1}><a href={`/sitemap/${i + 1}.xml`} className="hover:text-white hover:translate-x-1 transition-all duration-200 flex items-center gap-2"><FileText size={12}/> Services Locations {i + 1}</a></li>
              ))}
            </ul>
          </div>
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm font-semibold text-white/90">
              ...
              <li><a href="/api/products/feed" className="hover:text-white hover:translate-x-1 transition-all duration-200 flex items-center gap-2"><FileText size={14}/> Product Feed (XML)</a></li>
              <li><a href="/robots.txt" className="hover:text-white hover:translate-x-1 transition-all duration-200 flex items-center gap-2"><FileText size={14}/> Robots.txt</a></li>
